defmodule Day3 do
  ...
  ## Examples
      ...
      iex> Day3.parse_claim("#1 @ 604,670: 22x16")
      [1, 604, 670, 22, 16]
  """
  ...
  @doc """
  Find non-overlappng claim

  ## Examples

      iex> Day3.not_overlapping_claim([
      ...>    "#1 @ 1,3: 4x4",
      ...>    "#2 @ 3,1: 4x4",
      ...>    "#3 @ 5,5: 2x2"
      ...>  ])
      3
  """
  @spec not_overlapping_claim([claim]) :: id
  def not_overlapping_claim(claims) do
